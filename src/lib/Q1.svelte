...
<div class="flex justify-center flex-col">
    <div>
        <table
            class="table table-md border-2 border-base-content/5 mb-4 w-[1000px]"
        >
            <thead>
                <tr>
            ...
            <tbody>
                <tr>
                    ...
                    <td>
                        ...
                        all nodes, I can just stay at the most beneficial
                    </td>
                </tr>
                <tr>
                    <td>Constraint 1</td>
                    ...
                    <td>
                        Since this is a TSP variant, the subtours aren't
                        allowed.
                    </td>
                </tr>
                ...
                <tr>
                    <td>Constraint 2</td>
                    <td>
                        Each node can be visited at most once with the exception
                        of the starting point</td
                    >
                    <td>
                        TSP requieres this constraint and it makes sense since
                        you shouldn't be able to collect the prize multiple
                        times. If you allow that, looping through a pair of
                        close nodes con make our objective infinite.
                    </td>
                </tr>
                ...
                <tr>
                    <td> Variables 1</td>
                    <td>
                        Binary variable that indicates if a node was visited or
                        not
                    </td>
                    <td> </td>
                </tr>
                ...
                <tr>
                    ...
                    <td> Starting node </td>
                    <td>
                        I consider the starting node as free parameter that we
                        can optimize.
                    </td>
                </tr>
            </tbody>
        ...
        <p>
            The model must represent how profitable is to walk an arc between
            two nodes and help you to select the most convinient one
        </p>

        <table
            class="table table-md border-2 border-base-content/5 mt-4 w-full"
        >
            <thead>
                <tr>
                    <th colspan="3" class="font-bold text-lg text-primary">
            ...
            <tbody>
                <tr>
                    <td>1</td>
                    <td>
                        Since the starting point is not given, search for the
                        most promising node <span class="font-bold"
                ...
                <tr>
                    <td>2</td>
                    <td
                        >Calculate the delta between the minimum distance
                        between two arcs and the prize. After this, pick the
                        most profitable one.</td
                    >
                    <td></td>
                </tr>
                ...
                <tr>
                    <td>3</td>
                    <td
                        >If there is no profitable one, look one step ahead and
                ...
                <tr>
                    <td>4</td>
                    <td>
                        Repeat until no more nodes are left or no more
                        profitable paths are available.
                    </td>
                    <td>2</td>
                </tr>
            </tbody>
